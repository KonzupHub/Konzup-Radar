...
export const translations = {
  pt: {
    ...
    algorithmDesc: "Nosso algoritmo cruza três fontes de dados: probabilidades de mercados preditivos (Polymarket), índice de interesse de busca (Google Trends) e insights de IA (Gemini). Para eventos confirmados no mundo real que o mercado ainda não reflete, aplicamos um override manual de probabilidade.",
  ...
  en: {
    ...
    algorithmDesc: "Our algorithm crosses three data sources: prediction market probabilities (Polymarket), search interest index (Google Trends), and AI insights (Gemini). For confirmed real-world events not yet reflected by markets, we apply a manual probability override.",
  ...
  es: {
    ...
    projectDesc: "Konzup Radar monitorea 12 indicadores globales que impactan el turismo, cruzando mercados predictivos (Polymarket), tendencias de búsqueda (Google Trends) e inteligencia artificial (Gemini 2.0 Flash) para generar insights accionables. En eventos confirmados, el sistema aplica override manual para reflejar la realidad antes que los mercados.",
    algorithmTitle: "Cómo Calculamos los Riesgos",
    algorithmDesc: "Nuestro algoritmo cruza tres fuentes de datos: probabilidades de mercados predictivos (Polymarket), índice de interés de búsqueda (Google Trends) e insights de IA (Gemini). Para eventos confirmados que el mercado aún no refleja, aplicamos un override manual de probabilidad.",
